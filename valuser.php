...
{
if($row["username"]=="$_POST[fn]"){
if($row["password"]=="$_POST[pass]"){
echo "<br><br><center><h2 style='font-size: 30px;font-weight:600;font-family:Montserrat;text-transform: uppercase;' >The username And<span style='color:orange' > Password is validate successfully </span></center></h2>";
